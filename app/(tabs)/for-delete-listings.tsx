...
const initialState: State = {
  ...
  propertyType: '',
  listingType: 'Buy',
  priceRangeLow: Configs.propertyQueryParams.priceRangeLow,
  priceRangeHigh: Configs.propertyQueryParams.priceRangeHigh,
  sqmRangeLow: Configs.propertyQueryParams.sqmRangeLow,
  sqmRangeHigh: Configs.propertyQueryParams.sqmRangeHigh,
};
...
function PropertyListingSkeleton() {
  ...
  return (
    ...
    >
      <Skeleton colorMode={colorScheme.theme} width="100%" height={200} />
      <Spacer height={8} />
      <Skeleton colorMode={colorScheme.theme} width={'85%'} height={20} />
      <Spacer height={8} />
      <Skeleton colorMode={colorScheme.theme} width={'45%'} height={20} />
      <Spacer height={8} />
      <Skeleton colorMode={colorScheme.theme} width={'60%'} height={20} />
    </MotiView>
  );
}
            ...
            {(state.filterMode === 'filters' ||
              ...
              <Fragment>
                ...
                <View style={styles.rnCustomSliderContainer}>
                  <RNCustomSlider
                    formatToCurrency
                    min={Configs.propertyQueryParams.priceRangeLow}
                    max={Configs.propertyQueryParams.priceRangeHigh}
                ...
                >
                  <RNCustomSlider
                    min={Configs.propertyQueryParams.sqmRangeLow}
                    max={Configs.propertyQueryParams.sqmRangeHigh}
